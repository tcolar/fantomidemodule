...
public class FanGrammarHelper {
	...
	public static final int[] INSIGNIFICANT_TOKENS={FanLexer.WS, FanLexer.LB,
		FanLexer.INC_COMMENT, FanLexer.LINE_COMMENT, FanLexer.MULTI_COMMENT,
		FanLexer.EXEC_COMMENT, FanLexer.DOC};

	// Also check FanKeystrokeHandler (hevay use of lexer tokens)
