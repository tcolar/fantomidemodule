...
static{ // initializes tokens
	...
	token=new FanTokenID("SP_SEMI", 77, "separator");
	tokens.put(new Integer(77),token);
	token=new FanTokenID("INC_UNKNOWN_ITEM", 140, "error");
	...
	token=new FanTokenID("OP_MOD", 96, "operator");
	tokens.put(new Integer(96),token);
	token=new FanTokenID("PAR_R", 116, "");
	tokens.put(new Integer(116),token);
	token=new FanTokenID("OP_MINUS", 93, "operator");
	...
	token=new FanTokenID("OP_RANG_EXCL_OLD", 85, "operator");
	tokens.put(new Integer(85),token);
	token=new FanTokenID("AST_CLASS", 51, "");
	tokens.put(new Integer(51),token);
	token=new FanTokenID("OP_BITOR", 88, "operator");
	tokens.put(new Integer(88),token);
	token=new FanTokenID("QUOTSTR", 107, "string");
	tokens.put(new Integer(107),token);
	token=new FanTokenID("AST_TYPE", 65, "");
	tokens.put(new Integer(65),token);
	token=new FanTokenID("OP_BANG", 97, "operator");
	tokens.put(new Integer(97),token);
	token=new FanTokenID("PAR_L", 115, "");
	tokens.put(new Integer(115),token);
	token=new FanTokenID("OP_MULTI", 94, "operator");
	tokens.put(new Integer(94),token);
	token=new FanTokenID("KEYWORD", 129, "");
	...
	token=new FanTokenID("LINE_COMMENT", 119, "comment");
	...
	token=new FanTokenID("UNDERSCORE", 130, "");
	tokens.put(new Integer(130),token);
	token=new FanTokenID("OP_DIV", 95, "operator");
	tokens.put(new Integer(95),token);
	token=new FanTokenID("SP_COMMA", 72, "separator");
	...
	token=new FanTokenID("MULTI_COMMENT", 122, "comment");
	...
	token=new FanTokenID("OP_RANGE_EXCL", 86, "operator");
	tokens.put(new Integer(86),token);
	token=new FanTokenID("COMPL_QSTR", 126, "");
	tokens.put(new Integer(126),token);
	token=new FanTokenID("OP_TILDA", 100, "operator");
	tokens.put(new Integer(100),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("CP_EQUALITY", 82, "comparator");
	...
	token=new FanTokenID("COMPL_URI", 128, "");
	tokens.put(new Integer(128),token);
	token=new FanTokenID("OP_RANGE", 87, "operator");
	...
	token=new FanTokenID("OP_CURRY", 89, "operator");
	tokens.put(new Integer(89),token);
	token=new FanTokenID("SQ_BRACKET_L", 113, "");
	tokens.put(new Integer(113),token);
	token=new FanTokenID("OP_PLUS", 92, "operator");
	...
	token=new FanTokenID("HEXLETTER", 125, "");
	...
	token=new FanTokenID("HEX_HEADER", 131, "");
	tokens.put(new Integer(131),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 103, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 79, "assignment");
	...
	token=new FanTokenID("FRACTION", 136, "");
	tokens.put(new Integer(136),token);
	token=new FanTokenID("AST_INHERITANCE", 63, "");
	tokens.put(new Integer(63),token);
	token=new FanTokenID("SP_COLCOL", 66, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(74));
	token.setFixedText("[]");
	tokens.put(new Integer(74), token);
