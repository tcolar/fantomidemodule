...
static{ // initializes tokens
	...
	token=new FanTokenID("AS_INIT_VAL", 61, "");
	...
	token=new FanTokenID("CP_COMPARATORS", 68, "");
	...
	token=new FanTokenID("EXEC_COMMENT", 101, "");
	...
	token=new FanTokenID("LINE_COMMENT", 100, "");
	...
	token=new FanTokenID("AS_EQUAL", 63, "");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 64, "");
	tokens.put(new Integer(64),token);
	token=new FanTokenID("MULTI_COMMENT", 102, "");
	tokens.put(new Integer(102),token);
	token=new FanTokenID("STR", 92, "");
	...
	token=new FanTokenID("CP_EQUALITY", 67, "");
