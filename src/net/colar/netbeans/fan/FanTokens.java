...
static{ // initializes tokens
	...
	token=new FanTokenID("OP_MOD", 115, "operator");
	tokens.put(new Integer(115),token);
	token=new FanTokenID("PAR_R", 135, "");
	tokens.put(new Integer(135),token);
	token=new FanTokenID("OP_MINUS", 112, "operator");
	...
	token=new FanTokenID("AST_INC_DOTCALL", 77, "");
	tokens.put(new Integer(77),token);
	token=new FanTokenID("OP_RANG_EXCL_OLD", 104, "operator");
	tokens.put(new Integer(104),token);
	token=new FanTokenID("AST_CLASS", 51, "");
	tokens.put(new Integer(51),token);
	token=new FanTokenID("OP_BITOR", 107, "operator");
	tokens.put(new Integer(107),token);
	token=new FanTokenID("QUOTSTR", 126, "string");
	tokens.put(new Integer(126),token);
	token=new FanTokenID("AST_TYPE", 83, "");
	tokens.put(new Integer(83),token);
	token=new FanTokenID("OP_BANG", 116, "operator");
	...
	token=new FanTokenID("LINE_COMMENT", 138, "comment");
	tokens.put(new Integer(138),token);
	token=new FanTokenID("CP_COMPARATORS", 102, "comparator");
	tokens.put(new Integer(102),token);
	token=new FanTokenID("NUMBER", 131, "number");
	tokens.put(new Integer(131),token);
	token=new FanTokenID("AS_EQUAL", 97, "assignment");
	tokens.put(new Integer(97),token);
	token=new FanTokenID("KW_CATCH", 15, "keyword");
	tokens.put(new Integer(15),token);
	token=new FanTokenID("UNDERSCORE", 149, "");
	tokens.put(new Integer(149),token);
	token=new FanTokenID("OP_DIV", 114, "operator");
	tokens.put(new Integer(114),token);
	token=new FanTokenID("SP_COMMA", 91, "separator");
	...
	token=new FanTokenID("MULTI_COMMENT", 141, "comment");
	...
	token=new FanTokenID("BRACKET_L", 87, "");
	tokens.put(new Integer(87),token);
	token=new FanTokenID("AT", 129, "");
	tokens.put(new Integer(129),token);
	token=new FanTokenID("STR", 127, "string");
	tokens.put(new Integer(127),token);
	token=new FanTokenID("OP_RANGE_EXCL", 105, "operator");
	tokens.put(new Integer(105),token);
	token=new FanTokenID("SP_PIPE", 94, "separator");
	tokens.put(new Integer(94),token);
	token=new FanTokenID("COMPL_QSTR", 145, "");
	tokens.put(new Integer(145),token);
	token=new FanTokenID("OP_TILDA", 119, "operator");
	tokens.put(new Integer(119),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("CP_EQUALITY", 101, "comparator");
	...
	token=new FanTokenID("COMPL_URI", 147, "");
	...
	token=new FanTokenID("OP_RANGE", 106, "operator");
	...
	token=new FanTokenID("SQ_BRACKET_R", 133, "");
	...
	token=new FanTokenID("DIGIT", 143, "");
	...
	token=new FanTokenID("OP_CURRY", 108, "operator");
	tokens.put(new Integer(108),token);
	token=new FanTokenID("SQ_BRACKET_L", 132, "");
	tokens.put(new Integer(132),token);
	token=new FanTokenID("AST_INC_SAFEDOTCALL", 78, "");
	tokens.put(new Integer(78),token);
	token=new FanTokenID("OP_PLUS", 111, "operator");
	...
	token=new FanTokenID("HEXLETTER", 144, "");
	...
	token=new FanTokenID("HEX_HEADER", 150, "");
	tokens.put(new Integer(150),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 122, "operator");
	tokens.put(new Integer(122),token);
	token=new FanTokenID("LIST_TYPE", 93, "");
	...
	token=new FanTokenID("FRACTIONAL", 153, "");
	tokens.put(new Integer(153),token);
	token=new FanTokenID("OP_LSHIFT", 109, "operator");
	tokens.put(new Integer(109),token);
	token=new FanTokenID("EXEC_COMMENT", 139, "comment");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 98, "assignment");
	...
	token=new FanTokenID("AST_PARAM", 82, "");
	tokens.put(new Integer(82),token);
	token=new FanTokenID("FRACTION", 155, "");
	tokens.put(new Integer(155),token);
	token=new FanTokenID("AST_INHERITANCE", 81, "");
	tokens.put(new Integer(81),token);
	token=new FanTokenID("AST_INC_USING", 76, "");
	tokens.put(new Integer(76),token);
	token=new FanTokenID("SP_COLCOL", 85, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(93));
	token.setFixedText("[]");
	tokens.put(new Integer(93), token);
	token=tokens.get(new Integer(39));
	token.setFixedText("super");
	tokens.put(new Integer(39), token);
	token=tokens.get(new Integer(160));
	token.setFixedText("$");
	tokens.put(new Integer(160), token);
