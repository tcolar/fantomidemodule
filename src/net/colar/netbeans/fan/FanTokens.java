...
static{ // initializes tokens
	...
	token=new FanTokenID("EXPONENT", 148, "");
	tokens.put(new Integer(148),token);
	token=new FanTokenID("DSL", 112, "");
	tokens.put(new Integer(112),token);
	token=new FanTokenID("OP_AND", 92, "operator");
	...
	token=new FanTokenID("CHAR", 117, "character");
	tokens.put(new Integer(117),token);
	token=new FanTokenID("OP_2PLUS", 109, "operator");
	...
	token=new FanTokenID("SP_SEMI", 88, "separator");
	tokens.put(new Integer(88),token);
	token=new FanTokenID("INC_UNKNOWN_ITEM", 151, "error");
	...
	token=new FanTokenID("OP_MOD", 107, "operator");
	tokens.put(new Integer(107),token);
	token=new FanTokenID("PAR_R", 127, "");
	tokens.put(new Integer(127),token);
	token=new FanTokenID("OP_MINUS", 104, "operator");
	...
	token=new FanTokenID("MULTI_COMMENT", 133, "comment");
	...
	token=new FanTokenID("BRACKET_L", 79, "");
	tokens.put(new Integer(79),token);
	token=new FanTokenID("AT", 121, "");
	tokens.put(new Integer(121),token);
	token=new FanTokenID("STR", 119, "string");
	tokens.put(new Integer(119),token);
	token=new FanTokenID("OP_RANGE_EXCL", 97, "operator");
	tokens.put(new Integer(97),token);
	token=new FanTokenID("SP_PIPE", 86, "separator");
	tokens.put(new Integer(86),token);
	token=new FanTokenID("COMPL_QSTR", 137, "");
	tokens.put(new Integer(137),token);
	token=new FanTokenID("OP_TILDA", 111, "operator");
	tokens.put(new Integer(111),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("CP_EQUALITY", 93, "comparator");
	...
	token=new FanTokenID("COMPL_URI", 139, "");
	tokens.put(new Integer(139),token);
	token=new FanTokenID("OP_RANGE", 98, "operator");
	...
	token=new FanTokenID("OP_CURRY", 100, "operator");
	tokens.put(new Integer(100),token);
	token=new FanTokenID("SQ_BRACKET_L", 124, "");
	tokens.put(new Integer(124),token);
	token=new FanTokenID("AST_INC_SAFEDOTCALL", 70, "");
	tokens.put(new Integer(70),token);
	token=new FanTokenID("OP_PLUS", 103, "operator");
	...
	token=new FanTokenID("HEXLETTER", 136, "");
	...
	token=new FanTokenID("HEX_HEADER", 142, "");
	tokens.put(new Integer(142),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 114, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 90, "assignment");
	...
	token=new FanTokenID("AST_INC_USING", 68, "");
	tokens.put(new Integer(68),token);
	token=new FanTokenID("SP_COLCOL", 77, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(85));
	token.setFixedText("[]");
	tokens.put(new Integer(85), token);
	token=tokens.get(new Integer(39));
	token.setFixedText("super");
	tokens.put(new Integer(39), token);
	token=tokens.get(new Integer(152));
	token.setFixedText("$");
	tokens.put(new Integer(152), token);
