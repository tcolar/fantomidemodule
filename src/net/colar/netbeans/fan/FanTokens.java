...
static{ // initializes tokens
	...
	token=new FanTokenID("OP_MOD", 86, "operator");
	tokens.put(new Integer(86),token);
	token=new FanTokenID("PAR_R", 108, "");
	tokens.put(new Integer(108),token);
	token=new FanTokenID("OP_MINUS", 83, "operator");
	...
	token=new FanTokenID("COMPL_URI", 120, "");
	tokens.put(new Integer(120),token);
	token=new FanTokenID("OP_RANGE", 77, "operator");
	...
	token=new FanTokenID("OP_CURRY", 79, "operator");
	tokens.put(new Integer(79),token);
	token=new FanTokenID("SQ_BRACKET_L", 105, "");
	tokens.put(new Integer(105),token);
	token=new FanTokenID("OP_PLUS", 82, "operator");
	...
	token=new FanTokenID("HEXLETTER", 117, "");
	...
	token=new FanTokenID("HEX_HEADER", 123, "");
	tokens.put(new Integer(123),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 93, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 69, "assignment");
	...
	token=new FanTokenID("FRACTION", 128, "");
	tokens.put(new Integer(128),token);
	token=new FanTokenID("AST_INHERITANCE", 55, "");
	tokens.put(new Integer(55),token);
	token=new FanTokenID("SP_COLCOL", 58, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(63));
	token.setFixedText("[]");
	tokens.put(new Integer(63), token);
	...
	tokens.put(new Integer(19), token);
	token=tokens.get(new Integer(103));
	token.setFixedText("{");
	tokens.put(new Integer(103), token);
