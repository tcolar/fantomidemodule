...
static{ // initializes tokens
	...
	token=new FanTokenID("EXPONENT", 114, "");
	...
	token=new FanTokenID("LETTER", 116, "");
	tokens.put(new Integer(116),token);
	token=new FanTokenID("HEXNB", 109, "");
	tokens.put(new Integer(109),token);
	token=new FanTokenID("CHAR", 94, "character");
	...
	token=new FanTokenID("INCOMPLETE_STR", 105, "error");
	...
	token=new FanTokenID("QUOTSTR", 91, "string");
	...
	token=new FanTokenID("KEYWORD", 106, "");
	...
	token=new FanTokenID("UNDERSCORE", 107, "");
	...
	token=new FanTokenID("URI", 93, "string");
	...
	token=new FanTokenID("INCOMPLETE_", 117, "error");
	...
	token=new FanTokenID("HEX_HEADER", 108, "");
	...
	token=new FanTokenID("FRACTIONAL", 111, "");
	...
	token=new FanTokenID("DECIMAL", 110, "");
	...
	token=new FanTokenID("FRACTION", 113, "");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(58));
	token.setFixedText("[]");
	tokens.put(new Integer(58), token);
