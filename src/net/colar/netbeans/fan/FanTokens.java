...
static{ // initializes tokens
	...
	token=new FanTokenID("EXPONENT", 115, "");
	...
	token=new FanTokenID("LETTER", 117, "");
	tokens.put(new Integer(117),token);
	token=new FanTokenID("HEXNB", 110, "");
	...
	token=new FanTokenID("INCOMPLETE_DSL", 47, "");
	...
	token=new FanTokenID("MULTI_COMMENT", 104, "comment");
	...
	token=new FanTokenID("BRACKET_R", 54, "");
	...
	token=new FanTokenID("SP_COLON", 55, "separator");
	tokens.put(new Integer(55),token);
	token=new FanTokenID("BRACKET_L", 53, "");
	...
	token=new FanTokenID("SQ_BRACKET_R", 52, "");
	...
	token=new FanTokenID("SQ_BRACKET_L", 51, "");
	...
	token=new FanTokenID("HEX_HEADER", 109, "");
	...
	token=new FanTokenID("DECIMAL", 111, "");
	...
	token=new FanTokenID("INCOMPLETE_STRING", 48, "");
	tokens.put(new Integer(48),token);
	token=new FanTokenID("FRACTION", 114, "");
	tokens.put(new Integer(114),token);
	token=new FanTokenID("SP_COLCOL", 49, "separator");
