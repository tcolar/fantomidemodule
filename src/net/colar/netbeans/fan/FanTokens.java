...
static{ // initializes tokens
	...
	token=new FanTokenID("CHAR", 132, "character");
	tokens.put(new Integer(132),token);
	token=new FanTokenID("OP_2PLUS", 124, "operator");
	...
	token=new FanTokenID("OP_MOD", 122, "operator");
	tokens.put(new Integer(122),token);
	token=new FanTokenID("PAR_R", 142, "");
	tokens.put(new Integer(142),token);
	token=new FanTokenID("OP_MINUS", 119, "operator");
	...
	token=new FanTokenID("UNDERSCORE", 156, "");
	tokens.put(new Integer(156),token);
	token=new FanTokenID("OP_DIV", 121, "operator");
	...
	token=new FanTokenID("COMPL_DSL", 149, "");
	...
	token=new FanTokenID("MULTI_COMMENT", 148, "comment");
	...
	token=new FanTokenID("COMPL_ML_COMMENT", 147, "");
	...
	token=new FanTokenID("AT", 136, "");
	tokens.put(new Integer(136),token);
	token=new FanTokenID("STR", 134, "string");
	...
	token=new FanTokenID("COMPL_QSTR", 152, "");
	tokens.put(new Integer(152),token);
	token=new FanTokenID("OP_TILDA", 126, "operator");
	...
	token=new FanTokenID("COMPL_URI", 154, "");
	...
	token=new FanTokenID("SQ_BRACKET_R", 140, "");
	...
	token=new FanTokenID("DIGIT", 150, "");
	...
	token=new FanTokenID("HEXLETTER", 151, "");
	...
	token=new FanTokenID("OP_SAFEDYN_CALL", 129, "operator");
	...
	token=new FanTokenID("OP_LSHIFT", 116, "operator");
	tokens.put(new Integer(116),token);
	token=new FanTokenID("EXEC_COMMENT", 146, "comment");
