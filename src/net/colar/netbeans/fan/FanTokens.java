...
static{ // initializes tokens
	...
	token=new FanTokenID("OP_AND", 109, "operator");
	...
	token=new FanTokenID("OP_OR", 108, "operator");
	...
	token=new FanTokenID("OP_ELVIS", 105, "operator");
	...
	token=new FanTokenID("CP_EQUALITY", 110, "comparator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 107, "assignment");
