...
static{ // initializes tokens
	...
	token=new FanTokenID("SP_SEMI", 76, "separator");
	tokens.put(new Integer(76),token);
	token=new FanTokenID("INC_UNKNOWN_ITEM", 139, "error");
	...
	token=new FanTokenID("OP_MOD", 95, "operator");
	tokens.put(new Integer(95),token);
	token=new FanTokenID("PAR_R", 115, "");
	tokens.put(new Integer(115),token);
	token=new FanTokenID("OP_MINUS", 92, "operator");
	...
	token=new FanTokenID("MULTI_COMMENT", 121, "comment");
	...
	token=new FanTokenID("COMPL_URI", 127, "");
	tokens.put(new Integer(127),token);
	token=new FanTokenID("OP_RANGE", 86, "operator");
	...
	token=new FanTokenID("OP_CURRY", 88, "operator");
	tokens.put(new Integer(88),token);
	token=new FanTokenID("SQ_BRACKET_L", 112, "");
	tokens.put(new Integer(112),token);
	token=new FanTokenID("OP_PLUS", 91, "operator");
	...
	token=new FanTokenID("HEXLETTER", 124, "");
	...
	token=new FanTokenID("HEX_HEADER", 130, "");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 78, "assignment");
	...
	token=new FanTokenID("FRACTION", 135, "");
	tokens.put(new Integer(135),token);
	token=new FanTokenID("AST_INHERITANCE", 62, "");
	tokens.put(new Integer(62),token);
	token=new FanTokenID("SP_COLCOL", 65, "separator");
	...
	tokens.put(new Integer(6), token);
	token=tokens.get(new Integer(140));
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(73));
	token.setFixedText("[]");
	tokens.put(new Integer(73), token);
