...
static{ // initializes tokens
	...
	token=new FanTokenID("OP_MOD", 79, "operator");
	tokens.put(new Integer(79),token);
	token=new FanTokenID("PAR_R", 114, "");
	tokens.put(new Integer(114),token);
	token=new FanTokenID("OP_MINUS", 76, "operator");
	...
	token=new FanTokenID("OP_RANG_EXCL_OLD", 68, "operator");
	tokens.put(new Integer(68),token);
	token=new FanTokenID("OP_BITOR", 71, "operator");
	tokens.put(new Integer(71),token);
	token=new FanTokenID("QUOTSTR", 89, "string");
	tokens.put(new Integer(89),token);
	token=new FanTokenID("OP_BANG", 80, "operator");
	tokens.put(new Integer(80),token);
	token=new FanTokenID("PAR_L", 113, "");
	tokens.put(new Integer(113),token);
	token=new FanTokenID("OP_MULTI", 77, "operator");
	tokens.put(new Integer(77),token);
	token=new FanTokenID("KEYWORD", 110, "");
	...
	token=new FanTokenID("OP_POUND", 93, "operator");
	...
	token=new FanTokenID("ID", 88, "");
	tokens.put(new Integer(88),token);
	token=new FanTokenID("BRACKET_L", 96, "");
	tokens.put(new Integer(96),token);
	token=new FanTokenID("AT", 87, "");
	tokens.put(new Integer(87),token);
	token=new FanTokenID("STR", 90, "string");
	tokens.put(new Integer(90),token);
	token=new FanTokenID("SP_PIPE", 57, "separator");
	tokens.put(new Integer(57),token);
	token=new FanTokenID("OP_RANGE_EXCL", 69, "operator");
	tokens.put(new Integer(69),token);
	token=new FanTokenID("COMPL_QSTR", 107, "");
	tokens.put(new Integer(107),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("OP_TILDA", 83, "operator");
	tokens.put(new Integer(83),token);
	token=new FanTokenID("CP_EQUALITY", 65, "comparator");
	...
	token=new FanTokenID("COMPL_URI", 109, "");
	tokens.put(new Integer(109),token);
	token=new FanTokenID("OP_RANGE", 70, "operator");
	...
	token=new FanTokenID("OP_CURRY", 72, "operator");
	tokens.put(new Integer(72),token);
	token=new FanTokenID("SQ_BRACKET_L", 111, "");
	tokens.put(new Integer(111),token);
	token=new FanTokenID("OP_PLUS", 75, "operator");
	...
	token=new FanTokenID("HEXLETTER", 106, "");
	...
	token=new FanTokenID("OP_SAFEDYN_CALL", 86, "operator");
	...
	token=new FanTokenID("OP_ARROW", 58, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 62, "assignment");
	...
	token=new FanTokenID("OP_SAFE_CALL", 85, "operator");
	tokens.put(new Integer(85),token);
	token=new FanTokenID("COMPL_STR", 108, "");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(56));
	token.setFixedText("[]");
	tokens.put(new Integer(56), token);
	...
	tokens.put(new Integer(19), token);
	token=tokens.get(new Integer(96));
	token.setFixedText("{");
	tokens.put(new Integer(96), token);
