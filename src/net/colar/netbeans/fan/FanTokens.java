...
static{ // initializes tokens
	...
	token=new FanTokenID("OP_MOD", 80, "operator");
	tokens.put(new Integer(80),token);
	token=new FanTokenID("PAR_R", 102, "");
	tokens.put(new Integer(102),token);
	token=new FanTokenID("OP_MINUS", 77, "operator");
	...
	token=new FanTokenID("COMPL_URI", 114, "");
	tokens.put(new Integer(114),token);
	token=new FanTokenID("OP_RANGE", 71, "operator");
	...
	token=new FanTokenID("OP_CURRY", 73, "operator");
	tokens.put(new Integer(73),token);
	token=new FanTokenID("SQ_BRACKET_L", 99, "");
	tokens.put(new Integer(99),token);
	token=new FanTokenID("OP_PLUS", 76, "operator");
	...
	token=new FanTokenID("HEXLETTER", 111, "");
	...
	token=new FanTokenID("HEX_HEADER", 117, "");
	tokens.put(new Integer(117),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 87, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 63, "assignment");
	...
	token=new FanTokenID("OP_SAFE_CALL", 86, "operator");
	tokens.put(new Integer(86),token);
	token=new FanTokenID("COMPL_STR", 113, "");
	tokens.put(new Integer(113),token);
	token=new FanTokenID("LB", 103, "");
	...
	token=new FanTokenID("FRACTION", 122, "");
	tokens.put(new Integer(122),token);
	token=new FanTokenID("SP_COLCOL", 52, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(57));
	token.setFixedText("[]");
	tokens.put(new Integer(57), token);
	...
	tokens.put(new Integer(19), token);
	token=tokens.get(new Integer(97));
	token.setFixedText("{");
	tokens.put(new Integer(97), token);
