...
static{ // initializes tokens
	...
	token=new FanTokenID("EXPONENT", 147, "");
	tokens.put(new Integer(147),token);
	token=new FanTokenID("DSL", 111, "");
	tokens.put(new Integer(111),token);
	token=new FanTokenID("OP_AND", 91, "operator");
	...
	token=new FanTokenID("LETTER", 149, "");
	tokens.put(new Integer(149),token);
	token=new FanTokenID("HEXNB", 142, "");
	tokens.put(new Integer(142),token);
	token=new FanTokenID("CHAR", 116, "character");
	tokens.put(new Integer(116),token);
	token=new FanTokenID("OP_2PLUS", 108, "operator");
	...
	token=new FanTokenID("SP_SEMI", 87, "separator");
	tokens.put(new Integer(87),token);
	token=new FanTokenID("INC_UNKNOWN_ITEM", 150, "error");
	...
	token=new FanTokenID("OP_MOD", 106, "operator");
	tokens.put(new Integer(106),token);
	token=new FanTokenID("PAR_R", 126, "");
	tokens.put(new Integer(126),token);
	token=new FanTokenID("OP_MINUS", 103, "operator");
	...
	token=new FanTokenID("MULTI_COMMENT", 132, "comment");
	...
	token=new FanTokenID("BRACKET_L", 78, "");
	tokens.put(new Integer(78),token);
	token=new FanTokenID("AT", 120, "");
	tokens.put(new Integer(120),token);
	token=new FanTokenID("STR", 118, "string");
	tokens.put(new Integer(118),token);
	token=new FanTokenID("OP_RANGE_EXCL", 96, "operator");
	tokens.put(new Integer(96),token);
	token=new FanTokenID("SP_PIPE", 85, "separator");
	tokens.put(new Integer(85),token);
	token=new FanTokenID("COMPL_QSTR", 136, "");
	tokens.put(new Integer(136),token);
	token=new FanTokenID("OP_TILDA", 110, "operator");
	tokens.put(new Integer(110),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("CP_EQUALITY", 92, "comparator");
	...
	token=new FanTokenID("COMPL_URI", 138, "");
	tokens.put(new Integer(138),token);
	token=new FanTokenID("OP_RANGE", 97, "operator");
	...
	token=new FanTokenID("HEXLETTER", 135, "");
	...
	token=new FanTokenID("HEX_HEADER", 141, "");
	tokens.put(new Integer(141),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 113, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 89, "assignment");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(84));
	token.setFixedText("[]");
	tokens.put(new Integer(84), token);
	token=tokens.get(new Integer(39));
	token.setFixedText("super");
	tokens.put(new Integer(39), token);
	token=tokens.get(new Integer(151));
	token.setFixedText("$");
	tokens.put(new Integer(151), token);
