...
static{ // initializes tokens
	...
	token=new FanTokenID("DSL", 124, "");
	tokens.put(new Integer(124),token);
	token=new FanTokenID("OP_AND", 108, "operator");
	...
	token=new FanTokenID("SP_SEMI", 104, "separator");
	...
	token=new FanTokenID("OP_RANG_EXCL_OLD", 112, "operator");
	...
	token=new FanTokenID("OP_MULTI", 117, "operator");
	...
	token=new FanTokenID("OP_DIV", 118, "operator");
	...
	token=new FanTokenID("OP_OR", 107, "operator");
	...
	token=new FanTokenID("OP_ELVIS", 111, "operator");
	...
	token=new FanTokenID("OP_RANGE_EXCL", 113, "operator");
	...
	token=new FanTokenID("CP_EQUALITY", 109, "comparator");
	...
	token=new FanTokenID("OP_RANGE", 114, "operator");
	...
	token=new FanTokenID("OP_CURRY", 120, "operator");
	...
	token=new FanTokenID("OP_PLUS", 115, "operator");
	...
	token=new FanTokenID("OP_SAFEDYN_CALL", 102, "operator");
	...
	token=new FanTokenID("OP_ARROW", 103, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 106, "assignment");
	...
	token=new FanTokenID("OP_SAFE_CALL", 125, "operator");
