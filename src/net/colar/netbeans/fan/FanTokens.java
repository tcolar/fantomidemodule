...
static{ // initializes tokens
	...
	token=new FanTokenID("OP_MOD", 84, "operator");
	tokens.put(new Integer(84),token);
	token=new FanTokenID("PAR_R", 59, "");
	tokens.put(new Integer(59),token);
	token=new FanTokenID("OP_MINUS", 81, "operator");
	...
	token=new FanTokenID("ID", 93, "");
	tokens.put(new Integer(93),token);
	token=new FanTokenID("SP_COLON", 56, "separator");
	tokens.put(new Integer(56),token);
	token=new FanTokenID("BRACKET_L", 55, "");
	tokens.put(new Integer(55),token);
	token=new FanTokenID("AT", 92, "");
	tokens.put(new Integer(92),token);
	token=new FanTokenID("STR", 95, "string");
	tokens.put(new Integer(95),token);
	token=new FanTokenID("SP_PIPE", 62, "separator");
	tokens.put(new Integer(62),token);
	token=new FanTokenID("OP_RANGE_EXCL", 74, "operator");
	tokens.put(new Integer(74),token);
	token=new FanTokenID("COMPL_QSTR", 111, "");
	tokens.put(new Integer(111),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("OP_TILDA", 88, "operator");
	tokens.put(new Integer(88),token);
	token=new FanTokenID("CP_EQUALITY", 70, "comparator");
	...
	token=new FanTokenID("COMPL_URI", 113, "");
	tokens.put(new Integer(113),token);
	token=new FanTokenID("OP_RANGE", 75, "operator");
	...
	token=new FanTokenID("OP_CURRY", 77, "operator");
	tokens.put(new Integer(77),token);
	token=new FanTokenID("SQ_BRACKET_L", 53, "");
	tokens.put(new Integer(53),token);
	token=new FanTokenID("OP_PLUS", 80, "operator");
	...
	token=new FanTokenID("HEXLETTER", 110, "");
	...
	token=new FanTokenID("HEX_HEADER", 116, "");
	tokens.put(new Integer(116),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 91, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 67, "assignment");
	...
	token=new FanTokenID("OP_SAFE_CALL", 90, "operator");
	tokens.put(new Integer(90),token);
	token=new FanTokenID("COMPL_STR", 112, "");
	tokens.put(new Integer(112),token);
	token=new FanTokenID("LB", 102, "");
	...
	token=new FanTokenID("FRACTION", 121, "");
	tokens.put(new Integer(121),token);
	token=new FanTokenID("SP_COLCOL", 51, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(61));
	token.setFixedText("[]");
	tokens.put(new Integer(61), token);
	...
	tokens.put(new Integer(19), token);
	token=tokens.get(new Integer(55));
	token.setFixedText("{");
	tokens.put(new Integer(55), token);
