...
static{ // initializes tokens
	...
	token=new FanTokenID("SP_SEMI", 89, "separator");
	tokens.put(new Integer(89),token);
	token=new FanTokenID("INC_UNKNOWN_ITEM", 152, "error");
	...
	token=new FanTokenID("OP_MOD", 108, "operator");
	tokens.put(new Integer(108),token);
	token=new FanTokenID("PAR_R", 128, "");
	tokens.put(new Integer(128),token);
	token=new FanTokenID("OP_MINUS", 105, "operator");
	...
	token=new FanTokenID("MULTI_COMMENT", 134, "comment");
	...
	token=new FanTokenID("BRACKET_L", 80, "");
	tokens.put(new Integer(80),token);
	token=new FanTokenID("AT", 122, "");
	tokens.put(new Integer(122),token);
	token=new FanTokenID("STR", 120, "string");
	tokens.put(new Integer(120),token);
	token=new FanTokenID("OP_RANGE_EXCL", 98, "operator");
	tokens.put(new Integer(98),token);
	token=new FanTokenID("SP_PIPE", 87, "separator");
	tokens.put(new Integer(87),token);
	token=new FanTokenID("COMPL_QSTR", 138, "");
	tokens.put(new Integer(138),token);
	token=new FanTokenID("OP_TILDA", 112, "operator");
	tokens.put(new Integer(112),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("CP_EQUALITY", 94, "comparator");
	...
	token=new FanTokenID("OP_CURRY", 101, "operator");
	tokens.put(new Integer(101),token);
	token=new FanTokenID("SQ_BRACKET_L", 125, "");
	tokens.put(new Integer(125),token);
	token=new FanTokenID("AST_INC_SAFEDOTCALL", 71, "");
	tokens.put(new Integer(71),token);
	token=new FanTokenID("OP_PLUS", 104, "operator");
	...
	token=new FanTokenID("HEXLETTER", 137, "");
	...
	token=new FanTokenID("HEX_HEADER", 143, "");
	tokens.put(new Integer(143),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 115, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 91, "assignment");
	...
	token=new FanTokenID("AST_PARAM", 75, "");
	tokens.put(new Integer(75),token);
	token=new FanTokenID("FRACTION", 148, "");
	tokens.put(new Integer(148),token);
	token=new FanTokenID("AST_INHERITANCE", 74, "");
	tokens.put(new Integer(74),token);
	token=new FanTokenID("AST_INC_USING", 69, "");
	tokens.put(new Integer(69),token);
	token=new FanTokenID("SP_COLCOL", 78, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(86));
	token.setFixedText("[]");
	tokens.put(new Integer(86), token);
	token=tokens.get(new Integer(39));
	token.setFixedText("super");
	tokens.put(new Integer(39), token);
	token=tokens.get(new Integer(153));
	token.setFixedText("$");
	tokens.put(new Integer(153), token);
