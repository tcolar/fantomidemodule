...
static{ // initializes tokens
	...
	token=new FanTokenID("EXPONENT", 119, "");
	...
	token=new FanTokenID("LETTER", 121, "");
	tokens.put(new Integer(121),token);
	token=new FanTokenID("HEXNB", 114, "");
	...
	token=new FanTokenID("INC_UNKNOWN_ITEM", 122, "error");
	...
	token=new FanTokenID("KEYWORD", 111, "");
	...
	token=new FanTokenID("UNDERSCORE", 112, "");
	...
	token=new FanTokenID("HEXHEADER", 117, "");
	...
	token=new FanTokenID("NBTYPE", 120, "");
	...
	token=new FanTokenID("HEX_HEADER", 113, "");
	...
	token=new FanTokenID("FRACTIONAL", 116, "");
	...
	token=new FanTokenID("DECIMAL", 115, "");
	...
	token=new FanTokenID("FRACTION", 118, "");
