...
static{ // initializes tokens
	...
	token=new FanTokenID("OP_MOD", 85, "operator");
	tokens.put(new Integer(85),token);
	token=new FanTokenID("PAR_R", 60, "");
	tokens.put(new Integer(60),token);
	token=new FanTokenID("OP_MINUS", 82, "operator");
	...
	token=new FanTokenID("OP_RANG_EXCL_OLD", 74, "operator");
	tokens.put(new Integer(74),token);
	token=new FanTokenID("OP_BITOR", 77, "operator");
	tokens.put(new Integer(77),token);
	token=new FanTokenID("QUOTSTR", 95, "string");
	tokens.put(new Integer(95),token);
	token=new FanTokenID("OP_BANG", 86, "operator");
	tokens.put(new Integer(86),token);
	token=new FanTokenID("PAR_L", 59, "");
	tokens.put(new Integer(59),token);
	token=new FanTokenID("OP_MULTI", 83, "operator");
	...
	token=new FanTokenID("OP_POUND", 99, "operator");
	...
	token=new FanTokenID("AT", 93, "");
	tokens.put(new Integer(93),token);
	token=new FanTokenID("STR", 96, "string");
	tokens.put(new Integer(96),token);
	token=new FanTokenID("SP_PIPE", 63, "separator");
	tokens.put(new Integer(63),token);
	token=new FanTokenID("OP_RANGE_EXCL", 75, "operator");
	...
	token=new FanTokenID("OP_TILDA", 89, "operator");
	tokens.put(new Integer(89),token);
	token=new FanTokenID("CP_EQUALITY", 71, "comparator");
	...
	token=new FanTokenID("OP_RANGE", 76, "operator");
	...
	token=new FanTokenID("OP_SAFEDYN_CALL", 92, "operator");
	...
	token=new FanTokenID("OP_ARROW", 64, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 68, "assignment");
	...
	token=new FanTokenID("OP_SAFE_CALL", 91, "operator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(62));
	token.setFixedText("[]");
	tokens.put(new Integer(62), token);
