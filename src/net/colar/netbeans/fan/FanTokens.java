...
static{ // initializes tokens
	...
	token=new FanTokenID("CHAR", 106, "character");
	tokens.put(new Integer(106),token);
	token=new FanTokenID("OP_2PLUS", 95, "operator");
	...
	token=new FanTokenID("SP_SEMI", 74, "separator");
	...
	token=new FanTokenID("OP_POUND", 107, "operator");
	...
	token=new FanTokenID("SP_QMARK", 69, "separator");
	...
	token=new FanTokenID("AS_INIT_VAL", 73, "assignment");
	...
	token=new FanTokenID("OP_RANGE", 84, "operator");
	...
	token=new FanTokenID("OP_SAFEDYN_CALL", 100, "operator");
	...
	token=new FanTokenID("OP_ARROW", 72, "operator");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 76, "assignment");
	...
	token=new FanTokenID("OP_SAFE_CALL", 99, "operator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(70));
	token.setFixedText("[]");
	tokens.put(new Integer(70), token);
