...
static{ // initializes tokens
	...
	token=new FanTokenID("EXPONENT", 162, "");
	tokens.put(new Integer(162),token);
	token=new FanTokenID("DSL", 126, "");
	tokens.put(new Integer(126),token);
	token=new FanTokenID("OP_AND", 106, "operator");
	...
	token=new FanTokenID("LETTER", 164, "");
	tokens.put(new Integer(164),token);
	token=new FanTokenID("HEXNB", 157, "");
	tokens.put(new Integer(157),token);
	token=new FanTokenID("CHAR", 131, "character");
	tokens.put(new Integer(131),token);
	token=new FanTokenID("OP_2PLUS", 123, "operator");
	...
	token=new FanTokenID("OP_MOD", 121, "operator");
	tokens.put(new Integer(121),token);
	token=new FanTokenID("PAR_R", 141, "");
	tokens.put(new Integer(141),token);
	token=new FanTokenID("OP_MINUS", 118, "operator");
	...
	token=new FanTokenID("AST_INC_DOTCALL", 82, "");
	tokens.put(new Integer(82),token);
	token=new FanTokenID("OP_RANG_EXCL_OLD", 110, "operator");
	tokens.put(new Integer(110),token);
	token=new FanTokenID("AST_CLASS", 51, "");
	tokens.put(new Integer(51),token);
	token=new FanTokenID("OP_BITOR", 113, "operator");
	tokens.put(new Integer(113),token);
	token=new FanTokenID("QUOTSTR", 132, "string");
	tokens.put(new Integer(132),token);
	token=new FanTokenID("AST_TYPE", 89, "");
	tokens.put(new Integer(89),token);
	token=new FanTokenID("OP_BANG", 122, "operator");
	...
	token=new FanTokenID("LINE_COMMENT", 144, "comment");
	tokens.put(new Integer(144),token);
	token=new FanTokenID("CP_COMPARATORS", 108, "comparator");
	tokens.put(new Integer(108),token);
	token=new FanTokenID("NUMBER", 137, "number");
	tokens.put(new Integer(137),token);
	token=new FanTokenID("AS_EQUAL", 103, "assignment");
	tokens.put(new Integer(103),token);
	token=new FanTokenID("KW_CATCH", 15, "keyword");
	tokens.put(new Integer(15),token);
	token=new FanTokenID("UNDERSCORE", 155, "");
	tokens.put(new Integer(155),token);
	token=new FanTokenID("OP_DIV", 120, "operator");
	tokens.put(new Integer(120),token);
	token=new FanTokenID("SP_COMMA", 97, "separator");
	...
	token=new FanTokenID("SP_QMARK", 98, "separator");
	tokens.put(new Integer(98),token);
	token=new FanTokenID("AST_ID", 85, "");
	tokens.put(new Integer(85),token);
	token=new FanTokenID("HEXHEADER", 160, "");
	tokens.put(new Integer(160),token);
	token=new FanTokenID("AS_INIT_VAL", 95, "assignment");
	tokens.put(new Integer(95),token);
	token=new FanTokenID("COMPL_DSL", 148, "");
	tokens.put(new Integer(148),token);
	token=new FanTokenID("NBTYPE", 163, "");
	tokens.put(new Integer(163),token);
	token=new FanTokenID("KW_SUPER", 39, "keyword");
	tokens.put(new Integer(39),token);
	token=new FanTokenID("OP_2MINUS", 124, "operator");
	tokens.put(new Integer(124),token);
	token=new FanTokenID("AST_SCOPE", 84, "");
	tokens.put(new Integer(84),token);
	token=new FanTokenID("OP_RSHIFT", 116, "operator");
	...
	token=new FanTokenID("OP_OR", 105, "operator");
	tokens.put(new Integer(105),token);
	token=new FanTokenID("AST_MODIFIER", 86, "");
	tokens.put(new Integer(86),token);
	token=new FanTokenID("DOC", 136, "");
	...
	token=new FanTokenID("MULTI_COMMENT", 147, "comment");
	...
	token=new FanTokenID("BRACKET_L", 93, "");
	tokens.put(new Integer(93),token);
	token=new FanTokenID("AT", 135, "");
	tokens.put(new Integer(135),token);
	token=new FanTokenID("STR", 133, "string");
	tokens.put(new Integer(133),token);
	token=new FanTokenID("OP_RANGE_EXCL", 111, "operator");
	tokens.put(new Integer(111),token);
	token=new FanTokenID("SP_PIPE", 100, "separator");
	tokens.put(new Integer(100),token);
	token=new FanTokenID("COMPL_QSTR", 151, "");
	tokens.put(new Integer(151),token);
	token=new FanTokenID("OP_TILDA", 125, "operator");
	tokens.put(new Integer(125),token);
	token=new FanTokenID("KW_VIRTUAL", 25, "keyword");
	tokens.put(new Integer(25),token);
	token=new FanTokenID("CP_EQUALITY", 107, "comparator");
	...
	token=new FanTokenID("COMPL_URI", 153, "");
	...
	token=new FanTokenID("OP_RANGE", 112, "operator");
	...
	token=new FanTokenID("SQ_BRACKET_R", 139, "");
	...
	token=new FanTokenID("DIGIT", 149, "");
	...
	token=new FanTokenID("OP_CURRY", 114, "operator");
	tokens.put(new Integer(114),token);
	token=new FanTokenID("SQ_BRACKET_L", 138, "");
	tokens.put(new Integer(138),token);
	token=new FanTokenID("AST_INC_SAFEDOTCALL", 83, "");
	tokens.put(new Integer(83),token);
	token=new FanTokenID("OP_PLUS", 117, "operator");
	...
	token=new FanTokenID("HEXLETTER", 150, "");
	...
	token=new FanTokenID("HEX_HEADER", 156, "");
	tokens.put(new Integer(156),token);
	token=new FanTokenID("OP_SAFEDYN_CALL", 128, "operator");
	tokens.put(new Integer(128),token);
	token=new FanTokenID("LIST_TYPE", 99, "");
	...
	token=new FanTokenID("FRACTIONAL", 159, "");
	tokens.put(new Integer(159),token);
	token=new FanTokenID("OP_LSHIFT", 115, "operator");
	tokens.put(new Integer(115),token);
	token=new FanTokenID("EXEC_COMMENT", 145, "comment");
	...
	token=new FanTokenID("AS_ASSIGN_OP", 104, "assignment");
	...
	token=new FanTokenID("AST_PARAM", 88, "");
	tokens.put(new Integer(88),token);
	token=new FanTokenID("FRACTION", 161, "");
	tokens.put(new Integer(161),token);
	token=new FanTokenID("AST_INHERITANCE", 87, "");
	tokens.put(new Integer(87),token);
	token=new FanTokenID("AST_INC_USING", 81, "");
	tokens.put(new Integer(81),token);
	token=new FanTokenID("SP_COLCOL", 91, "separator");
	...
	tokens.put(new Integer(41), token);
	token=tokens.get(new Integer(99));
	token.setFixedText("[]");
	tokens.put(new Integer(99), token);
	token=tokens.get(new Integer(39));
	token.setFixedText("super");
	tokens.put(new Integer(39), token);
	token=tokens.get(new Integer(166));
	token.setFixedText("$");
	tokens.put(new Integer(166), token);
