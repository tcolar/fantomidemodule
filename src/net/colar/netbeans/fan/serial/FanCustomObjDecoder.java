...
/**
 * Copy of Fantom ObjDecoder with small change to support java types
 * See: readSimpleType for the hack
 * TODO: remove this ugly stuff once Fantom support java object serialization builtin
 *
 * @author thibautc
 */
public class FanCustomObjDecoder
{

	public static Object decode(String s)
	{
		return new FanCustomObjDecoder(FanStr.in(s), null).readObj();
	}
...
//////////////////////////////////////////////////////////////////////////
	 ...
	 */
	public FanCustomObjDecoder(InStream in, Map options)
	{
...
//////////////////////////////////////////////////////////////////////////
	...
	{
		if (symbolsMapType == null)
		{
			symbolsMapType = new MapType(Sys.StrType, Sys.ObjType.toNullable());
		}
		if (map == null)
		{
			map = new Map(symbolsMapType);
		}
		readHeader();
		while (curt != Token.EOF)
		{
			...
			{
				id = consumeId("Expecting symbol name");
			}
...
//////////////////////////////////////////////////////////////////////////
	...
	private Type readSimpleType()
	{
		...
		// Thib : Deal with java type.
		if (n.startsWith("__java__"))
		{
			n = n.replaceFirst("__java__", "[java]");
			while(tokenizer.type == Token.ID || tokenizer.type == Token.DOT)
			{
				n += (String) (tokenizer.type==Token.DOT?".":tokenizer.val);
				consume();
			}
			consume(Token.DOUBLE_COLON, "Expected ::");
			String typeName = consumeId("Expected type name");
			return JavaType.make(n, typeName);
		}
		// End thib
		...
		if (pod == null)
		{
			throw err("Pod not found: " + n, line);
		}
		...
		if (type == null)
		{
			throw err("Type not found: " + n + "::" + typeName, line);
		}
		return type;
	}
...
//////////////////////////////////////////////////////////////////////////
	...
	private Symbol readSymbolLiteral()
	{
		...
		if (s == null)
		{
			throw err("Symbol not found: " + n + "::" + symbolName);
		}
		return s;
	}
...
//////////////////////////////////////////////////////////////////////////
	...
	static class UsingPod extends Using
	{
		...
		{
			return pod.findType(n, false);
		}

		Symbol resolveSymbol(String n)
		{
			return pod.symbol(n, false);
		}
		final Pod pod;
	}
	...
	static class UsingType extends Using
	{
		...
		Type resolve(String n)
		{
			return name.equals(n) ? type : null;
		}
